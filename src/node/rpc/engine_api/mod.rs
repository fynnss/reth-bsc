...
pub struct BscEngineApi {
    ...
    engine_handle:
        Arc<BeaconConsensusEngineHandle<crate::node::rpc::engine_api::payload::BscPayloadTypes>>,
}
...
impl BscEngineApi {
    ...
    pub fn new(
        engine_handle: Arc<
            BeaconConsensusEngineHandle<crate::node::rpc::engine_api::payload::BscPayloadTypes>,
        >,
    ) -> Self {
        Self { engine_handle }
    }
